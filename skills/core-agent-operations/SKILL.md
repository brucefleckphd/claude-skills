...
description: Foundational autonomous agent protocols with verified execution. Establishes context management, consumption receipts, requirements traceability, and persistent progress logging for reliable multi-session work.
---
